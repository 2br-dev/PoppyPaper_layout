...
class Polygon {
  ...
  draw(){
    this.shapeshifter.ctx.save();
    this.shapeshifter.ctx.beginPath();
    this.shapeshifter.ctx.fillStyle = 'rgba(' + this.color[0] + ',' + this.color[1] + ',' + this.color[2] + ',' + this.opacity + ')';
    for(var i=0; i<this.points.length; i++){
      if(i==0){
        this.shapeshifter.ctx.moveTo(this.shapeshifter.x + this.x+this.points[i].x*this.shapeshifter.options.scale, this.shapeshifter.y+this.y+this.points[i].y*this.shapeshifter.options.scale);
      } else {
        this.shapeshifter.ctx.lineTo(this.shapeshifter.x+this.x+this.points[i].x*this.shapeshifter.options.scale, this.shapeshifter.y+this.y+this.points[i].y*this.shapeshifter.options.scale);
      }
    }
    this.shapeshifter.ctx.lineWidth = this.strokeOpts.lineWidth;
    this.shapeshifter.ctx.strokeStyle = 'rgba(' + this.strokeOpts.color[0] + ',' + this.strokeOpts.color[1] + ',' + this.strokeOpts.color[2] + ',' + this.strokeOpts.opacity + ')';
    this.shapeshifter.ctx.stroke();
    this.shapeshifter.ctx.fill();
    this.shapeshifter.ctx.restore();
  }
}
